      ...
      <div className="border rounded-lg p-4 shadow">
        ...
        <div className="flex space-x-2 mt-2">
          {myProjects[0].images.map((img, idx) => (
            <img key={idx} src={img} alt={myProjects[0].title} className="w-1/2 h-auto object-contain rounded" />
          ))}
        </div>
      ...
      <div className="border rounded-lg p-4 shadow">
        ...
        <div className="flex space-x-2 mt-2">
          {myProjects[1].images.map((img, idx) => (
            <img key={idx} src={img} alt={myProjects[1].title} className="w-1/2 h-auto object-contain rounded" />
          ))}
        </div>
        <div className="mt-4 flex space-x-4">
            <a
      ...
      <div className="border rounded-lg p-4 shadow">
        ...
        <div className="flex space-x-2 mt-2">
          {myProjects[2].images.map((img, idx) => (
            <img key={idx} src={img} alt={myProjects[2].title} className="w-1/2 h-auto object-contain rounded" />
          ))}
        </div>
        <div className="mt-4 flex space-x-4">
            <a
